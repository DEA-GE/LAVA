...
parser.add_argument(
    "--scenario", help="scenario name (overrides config.yaml if provided)"
)
parser.add_argument(
    "--technology", help="technology (overrides config.yaml if provided)"
)
...
if args.method == "snakemake":
    ...
    technology = (
        args.technology if args.technology is not None else config.get("technology")
    )
    scenario = (
        args.scenario if args.scenario is not None else config.get("scenario", "ref")
    )
