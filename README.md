...
* __landcover__: [CORINE land cover global dataset](https://zenodo.org/records/3939050) covers the whole globe with a resolution of ~100m. Download the file from zenodo named __*PROBAV_LC100_global_v3.0.1_2019-nrt_Discrete-Classification-map_EPSG-4326.tif*__. Leave the name as it is and put it in the __"Raw_Spatial_Data"__ folder. :warning: Attention: the file size is 1.7 GB
