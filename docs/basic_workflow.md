...
> **Note:** An overview of possible exclusion criterias found in selected literature can be downloaded [here](assets/literature_overview.xlsx).
...
> **Note:** A template to document the exclusion parameters and data sources can be downloaded [here](assets/exclusion_parameters_overview.xlsx).
