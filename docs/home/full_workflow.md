...
Run the preprocessing script `spatial_data_prep.py` after configuring the study region. It clips the raw inputs to the
...
Run `suitability.py` after both solar and wind exclusions are available. The script aligns
